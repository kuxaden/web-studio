...
"use strict";function _toConsumableArray(t){return _arrayWithoutHoles(t)||_iterableToArray(t)||_unsupportedIterableToArray(t)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(t,e){var o;if(t)return"string"==typeof t?_arrayLikeToArray(t,e):"Map"===(o="Object"===(o=Object.prototype.toString.call(t).slice(8,-1))&&t.constructor?t.constructor.name:o)||"Set"===o?Array.from(t):"Arguments"===o||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)?_arrayLikeToArray(t,e):void 0}function _iterableToArray(t){if("undefined"!=typeof Symbol&&null!=t[Symbol.iterator]||null!=t["@@iterator"])return Array.from(t)}function _arrayWithoutHoles(t){if(Array.isArray(t))return _arrayLikeToArray(t)}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var o=0,n=new Array(e);o<e;o++)n[o]=t[o];return n}function openMenu(){document.querySelector(".menu-list").classList.toggle("menu-list--active"),document.querySelector(".navbar-btn").classList.toggle("navbar-btn--active")}function closeMenu(){document.querySelector(".menu-list").classList.remove("menu-list--active"),document.querySelector(".navbar-btn").classList.remove("navbar-btn--active")}$(".stage__item").click(function(t){$(".stage__item").removeClass("stage__item--active"),$(this).addClass("stage__item--active")}),$(".portfolio__item").click(function(t){$(".portfolio__item").removeClass("portfolio__item--scroll"),$(this).addClass("portfolio__item--scroll")}),$(".portfolio__item").click(function(t){$(".portfolio__item").removeClass("portfolio__item--scroll"),$(this).addClass("portfolio__item--scroll")}),$(document).ready(function(){$(".slider").slick({infinite:!1})}),$(".stage__item0").click(function(t){$(".slider").slick("goTo",0)}),$(".stage__item1").click(function(t){$(".slider").slick("goTo",1)}),$(".stage__item2").click(function(t){$(".slider").slick("goTo",2)}),$(".stage__item3").click(function(t){$(".slider").slick("goTo",3)}),$(".stage__item4").click(function(t){$(".slider").slick("goTo",4)}),$(".stage__item5").click(function(t){$(".slider").slick("goTo",5)}),$(".stage__item6").click(function(t){$(".slider").slick("goTo",6)}),$(document).on("click",".slick-arrow.slick-next",function(t){var e=$(".stage__list").find(".stage__item--active");e.removeClass("stage__item--active"),e.next().addClass("stage__item--active")}),$(document).on("click",".slick-arrow.slick-prev",function(t){var e=$(".stage__list").find(".stage__item--active");e.removeClass("stage__item--active"),e.prev().addClass("stage__item--active")});var prevScrollpos=window.pageYOffset,carusel=(window.onscroll=function(){closeMenu();var t=window.pageYOffset;document.querySelector(".header").style.top=t<prevScrollpos?"0":"-90px",prevScrollpos=t},document.querySelector(".services-block"));function startup(){document.querySelector(".about").addEventListener("touchstart",handleStart,!1)}function handleStart(t){console.log("startAnimate"),startAnimate()}function startAnimate(){document.querySelector(".").classList.add("animated");for(var t=document.querySelectorAll(".about-block__text-item"),e=0;e<t.length;++e)t[e].classList.add("animated");closeMenu()}carusel.innerHTMl="",_toConsumableArray(carusel.children).sort(function(){return Math.random()-.5}).forEach(function(t){return carusel.append(t)}),"ontouchstart"in window?console.log("/* browser with Touch Events support */"):console.log("/* browser with Touch Events NO support */"),document.addEventListener("DOMContentLoaded",startup);var flag=1,mon=documen.getElementById("imgmon"),tab=documen.getElementById("imgtab"),mob=documen.getElementById("imgmob");function changeImage(){flag=1==flag?(document.mon.src="img/content/mon01.webp",document.tab.src="img/content/tab01.webp",document.mob.src="img/content/mob01.webp",2):2==flag?(document.mon.src="img/content/mon02.webp",document.tab.src="img/content/tab02.webp",document.mob.src="img/content/mob02.webp",3):(document.mon.src="img/content/mon03.webp",document.tab.src="img/content/tab03.webp",document.mob.src="img/content/mob03.webp",1)}
