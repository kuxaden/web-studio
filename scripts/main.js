...
function changeImage() {
  if (flag == 1) {
    document.imgmon.src = 'img/content/mon01.webp';
    document.imgtab.src = 'img/content/tab01.webp';
    document.imgmob.src = 'img/content/mob01.webp';
    flag = 2;
  } else if (flag == 2) {
    document.imgmon.src = 'img/content/mon02.webp';
    document.imgtab.src = 'img/content/tab02.webp';
    document.imgmob.src = 'img/content/mob02.webp';
    flag = 3;
  } else {
   document.imgmon.src = 'img/content/mon03.webp';
   document.imgtab.src = 'img/content/tab03.webp';
   document.imgmob.src = 'img/content/mob03.webp';
   flag = 1;
  }
}
